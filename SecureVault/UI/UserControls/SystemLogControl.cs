// ============================================
// SecureVault - System Log (Redesigned)
...
namespace SecureVault.UI.UserControls
{
    public class SystemLogControl : UserControl
    {
        ...
        private void BuildUI()
        {
            ...
            filterFlow.Controls.Add(new Label { Text = "User:", Font = AppTheme.BodyRegular, ForeColor = AppTheme.TextSecondary, BackColor = Color.Transparent, AutoSize = true, Margin = new Padding(0, 14, 6, 0) });
            _userFilter = new StyledComboBox { Size = new Size(200, 32), Margin = new Padding(0, 10, 12, 0) };
            ...
            {
                Dock = DockStyle.Fill,
                EmptyMessage = "No system logs found for this period"
            };
